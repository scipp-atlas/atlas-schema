...
class NtupleSchema(BaseSchema):  # type: ignore[misc]
    ...
    | ``'ph_eta'``                           | ``'ph'``          | ``'eta'``                 | ``None``                        |
    +----------------------------------------+-------------------+---------------------------+---------------------------------+
    | ``'ph_phi_MUON_SAGITTA_RESBIAS__1up'`` | ``'ph'``          | ``'phi'``                 | ``'MUON_SAGITTA_RESBIAS__1up'`` |
    +----------------------------------------+-------------------+---------------------------+---------------------------------+
    | ``'mu_TTVA_effSF_baseline_NOSYS'``     | ``'mu'``          | ``'TTVA_effSF_baseline'`` | ``'NOSYS'``                     |
    +----------------------------------------+-------------------+---------------------------+---------------------------------+
    | ``'recojet_antikt4PFlow_pt_NOSYS'``    | ``'recojet'``     | ``'antikt4PFlow_pt'``     | ``'NOSYS'``                     |
    +----------------------------------------+-------------------+---------------------------+---------------------------------+
    | ``'recojet_antikt10UFO_m'``            | ``'recojet'``     | ``'m'``                   | ``None``                        |
    +----------------------------------------+-------------------+---------------------------+---------------------------------+
